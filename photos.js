...
//clone figure element or fifth image and edit to be first image 
...
//add appropriate src values to two new img elements
  ...
  //disable the 'show more images' button after it has been selectd once
...
//declare variable for document element with id of leftarrow
...
//declare variable for document element with id of rightarrow 
   var rightarrow = document.getElementById("rightarrow");

//add an event handler to the specified document element (rightarrow)
//the rightArrow() function will execute when user clicks the right navigation arrow 
